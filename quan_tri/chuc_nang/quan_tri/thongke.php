...
<div class="container-fluid">
    ...
    <form class="form-signin" method="POST" action="?menu=thongke">
        <div class="row">
            <div class="col-md-12 col-md-offset-2">
                <div class="">
                    <h2><label for="Choose Report"  style="color:#E74C3C">Chọn thời gian</label></h2>
    ...
    <div class="col-md-5 col-md-offset-2">
         <div class=" float-left">
            <br>
            <h4><label style="color:#E74C3C" for="Total">Tổng tiền:</label><?php echo " ".number_format($tongtien,0,",","."); ?></h4> 
            <h4><label style="color:#E74C3C" for="Total">Tổng tiền đơn thành công:</label><?php echo " ".number_format($tongtien2,0,",","."); ?></h4> 
