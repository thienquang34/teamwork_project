        ...
        <div class="card-body">
            <div class="table-responsive">
				...
				<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
					...
					<tr>
						<td colspan="4">
							<a class="btn btn-primary"  onclick="return confirm('Bạn có mún hủy hóa đơn?');"  href="?menu=huy_donhang&ma_hoadon=<?php echo $row['mahd']; ?>&soluong=<?php echo $soluong; ?>&masp=<?php echo $masp; ?>">Hủy hóa đơn</a>			
						</td>
					</tr>
					<?php
					...
					<tr>
						<td colspan="4">
							<a class="btn btn-primary"  onclick="return confirm('Bạn có mún hủy hóa đơn?');"  href="?menu=huy_donhang&ma_hoadon=<?php echo $row['mahd']; ?>">Hủy hóa đơn</a>
