...
$tg=0;
$list_product="";
	echo "Xin chào ".$tenkh.", bạn đã thêm vào giỏ hàng các sản phẩm của chúng tôi là: <br>";
?>
...
<p class="alert alert-success">Vui lòng bấm vào nút mua hàng bên dưới để xác nhận mua hàng.</p>
