<div class="panel panel-warning">
    <div class="panel-heading">Áo sơ mi</div>
    <div class="panel-body">
		...
		<?php
			...
			$page=$page-1;
			$limit= 8;
			$sql="select * from san_pham where loaisp like 'somi'";
		...
		?>
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="product">
				<?php
					$sl= "select * from san_pham where loaisp like 'somi' limit ".$start.",".$limit;
				...
				<nav>
					<ul class="pagination">
						<?php 
						    if($page==0) {
						    	if($total>1) { 
						    		$page=$page+2;
						    		$prev="";
						    		$next= '<a href="?menu=somi&page='.$page.'"aria-label="Next"><span class="fa fa-step-forward"></span></a>';		      		
						    	}else {
						    		$prev="";
						    		$next="";
						    	} 
						    	...
						    	if($page==$total-1) {
						    		$prpage= $page;
						    		$firstpage='<a href="?menu=somi&page=1" aria-label="First"><span class="fa fa-fast-backward"></span></a>';
						    		$endpage="";
						    		$prev='<a href="?menu=somi&page='.$prpage.'" aria-label="Next"><span class="fa fa-step-backward"></span></a>';
						    		$page=$page-2;
						    		$next= "";
						    	}else {
						    		$prpage=$page;
						...
						<?php 	
							...
							for($i=1; $i<=$total; $i++){
						?>
						<li><a href="?menu=somi&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
						<?php
							}	
						?>
						<li><?php echo $next; ?></li>	    
