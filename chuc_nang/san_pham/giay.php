<div class="panel panel-warning">
    <div class="panel-heading">Giày</div>
    <div class="panel-body">
		...
		<?php
			...
			$page=$page-1;
			$limit= 8;
			$sql="select * from san_pham where loaisp like 'giay'";
		...
		?>
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="product">
				<?php
					$sl= "select * from san_pham where loaisp like 'giay' limit ".$start.",".$limit;
				...
				<nav>
					<ul class="pagination">
						<?php 
						    if($page==0){
						    	if($total>1){ 
						    		$page=$page+2;
						    		$prev="";
						    		$next= '<a href="?menu=giay&page='.$page.'"aria-label="Next"><span class="fa fa-step-forward"></span></a>';		      		
						    	}else{
						    		$prev="";
						    		$next="";
						    	} 
						    	...
						    	if($page==$total-1){
						    		$prpage= $page;
						    		$firstpage='<a href="?menu=giay&page=1" aria-label="First"><span class="fa fa-fast-backward"></span></a>';
						    		$endpage="";
						    		$prev='<a href="?menu=giay&page='.$prpage.'" aria-label="Next"><span class="fa fa-step-backward"></span></a>';
						    		$page=$page-2;
						    		$next= "";
						    	}else{
						    		$prpage=$page;
						...
						<?php 	
							...
							for($i=1; $i<=$total; $i++){
						?>
						<li><a href="?menu=giay&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
						<?php
							}	
						?>
						<li><?php echo $next; ?></li>	    
